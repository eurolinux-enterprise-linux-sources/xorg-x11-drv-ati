...
%if 0%{?gitdate}
Source0: %{tarball}-%{gitdate}git%{gitversion}.tar.xz
%else
...
BuildRequires: kernel-headers >= 2.6.32-33
BuildRequires: automake autoconf libtool pkgconfig
BuildRequires: xorg-x11-util-macros >= 1.1.5
BuildRequires: xorg-x11-server-devel >= 1.15.0
...
Requires:  hwdata
Requires:  xorg-x11-server-Xorg >= 1.10.99.902
...
Firmware for ATI R600/R700 IRQs + Evergreen/Northern Islands + Fusion

%prep
%if 0%{?gitdate}
%setup -q -n %{tarball}-%{gitdate}git%{gitversion} -a 2
%else
...
* Mon May 05 2014 Jérôme Glisse <jglisse@redhat.com> 7.3.99-1
- git snapshot ati 7.3.99 and updated firmware

* Wed Apr 23 2014 Adam Jackson <ajax@redhat.com> 7.2.0-1
- ati 7.2.0

* Mon Oct 14 2013 Jerome Glisse <jglisse@redhat.com> 7.1.0-3
- Add oland firmware fix (new firmware source file) (#1017966)

* Mon Oct 14 2013 Jerome Glisse <jglisse@redhat.com> 7.1.0-2
- Add oland firmware fix (#1017966)

* Tue Jul 16 2013 Jerome Glisse <jglisse@redhat.com> 7.1.0-1
- Git snapshot enable glamor acceleration hd7xxx GPU

* Wed Aug 22 2012 airlied@redhat.com - 6.99.99-1
- rebuild for server ABI requires

* Mon Aug 06 2012 Jerome Glisse <jglisse@redhat.com> 6.99.99-0
- Rebase for RHEL 6.4

* Thu Apr 12 2012 Jerome Glisse <jglisse@redhat.com> 6.14.2-9
- Require libudev-devel so hotplug works #749286

* Wed Feb 29 2012 Jerome Glisse <jglisse@redhat.com> 6.14.2-8
- Add new pci ids for new GPU supports (#788166)

* Thu Oct 20 2011 Jerome Glisse <jglisse@redhat.com> 6.14.2-7
- Fallback to vesa for GPU without UMS (#747131)

* Fri Jul 22 2011 Jerome Glisse <jglisse@redhat.com> 6.14.2-6
- RHEL6.2 bring in fixes since 6.14.2 release (#713766)

* Wed Jun 29 2011 Jerome Glisse <jglisse@redhat.com> 6.14.2-5
- RHEL6.2 add build dependency (#713766)

* Wed Jun 29 2011 Jerome Glisse <jglisse@redhat.com> 6.14.2-4
- RHEL6.2 actually upload the patch (#713766)

* Wed Jun 29 2011 Jerome Glisse <jglisse@redhat.com> 6.14.2-3
- RHEL6.2 rebase proper background patch for last xserver (#713766)

* Wed Jun 29 2011 Jerome Glisse <jglisse@redhat.com> 6.14.2-2
- RHEL6.2 rebase against lastest xserver (#713766)

* Thu Jun 23 2011 Dave Airlie <airlied@redhat.com> 6.14.2-1
- rebase to latest upstream release + llano support + new firmware (#713622)
